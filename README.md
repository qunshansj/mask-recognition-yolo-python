...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于YOLOv7口罩识别系统"))
        self.label.setText(_translate("MainWindow", "基于YOLOv7口罩识别系统"))
...
# 9.系统整合
下图[完整源码&环境部署视频教程&自定义UI界面](https://s.xiaocichang.com/s/476cda)
![2.png](90d3624700969a75368488d55f9494c7.png)
参考博客[《\[YOLOv7\]基于YOLOv7的口罩识别系统(源码＆部署教程)》](https://mbd.pub/o/qunma/work)


# 10.参考文献:
***
[1]肖博健,万烂军,陈俊权.采用YOLOV5模型的口罩佩戴识别研究[J].福建电脑.2021,(3).35-37.DOI:10.16707/j.cnki.fjpc.2021.03.009.
[2]董艳花,张树美,赵俊莉.有遮挡人脸识别方法综述[J].计算机工程与应用.2020,(9).1-12.DOI:10.3778/j.issn.1002-8331.2001-0029.
[3]肖俊杰.基于YOLOv3和YCrCb的人脸口罩检测与规范佩戴识别[J].软件.2020,(7).164-169.DOI:10.3969/j.issn.1003-6970.2020.07.033.
[4]刘振宇,姜雨濛.基于模板匹配的遮挡工件识别方法[J].计算机应用研究.2020,(S2).392-394,397.
[5]王明沂.局部遮挡下的人脸识别方法研究[D].2020
[6]高雷.基于深度学习的人脸识别与应用研究[D].2020
[7]Xiaoming Jiang,Xiaoming Jiang,Fugui Xiang,等.YOLOv3_Slim for Face Mask Recognition[J].Journal of Physics: Conference Series.2021,1771(1).012002 (8pp).DOI:10.1088/1742-6596/1771/1/012002.
[8]Guanhao Yang,Wei Feng,Jintao Jin,等.Face Mask Recognition System with YOLOV5 Based on Image Recognition[C].
